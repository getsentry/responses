...
class RequestsMock:
    ...
    @property
    def passthru_prefixes(self) -> Tuple[str, ...]: ...
    @passthru_prefixes.setter
    def passthru_prefixes(self, prefixes: Tuple[str, ...]) -> None: ...
    def remove(
        self,
...
class _AddPassthru(Protocol):
    def __call__(
        self, prefix: Union[Pattern[str], str], method: str = ..., check_fired: int = ...
    ) -> None: ...
